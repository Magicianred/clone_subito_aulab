...
<div class="container pt-custom pb-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-third font-white h4 font-weight-bold">{{ __('Register') }}</div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn font-weight-bold btn-color-custom text-uppercase">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
